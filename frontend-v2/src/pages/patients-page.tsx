...
export function PatientsPage() {
  ...
  return <div className="mx-auto max-w-[1440px]">
    <PageHeader eyebrow="患者管理" title="患者列表" description="查找患者并进入其问诊时间线与 AI 报告。" actions={<div className="text-sm text-muted">{query.data ? `共 ${query.data.length} 位患者` : "正在获取患者"}</div>} />
