...
const navigation = [
  ...
  { label: "医生管理", icon: Stethoscope, to: "/admin/doctors", enabled: false },
  { label: "患者管理", icon: Users, to: "/admin/patients", enabled: false },
